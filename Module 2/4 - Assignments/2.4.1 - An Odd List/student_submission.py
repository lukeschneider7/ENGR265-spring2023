...
middle_index = (list_length - 1)/2   # modify this line to perform the correct operation

# use [] to access the middle element. Set it equal to middle_element
middle_index_plus = middle_index + 1
middle_element = odd_list[int(middle_index):int(middle_index_plus)]   # modify this line to perform the correct operation
